                        ...
                        <div class="card h-100 mb-0 shadow-none rounded-0">
                            ...
                            <div class="card-body chat-height p-0">
                                ...
                                <ul class="m-0 p-0 users-chat mt-2">
                                    <a href="javascript:void(0)" v-for="item in 50">
                                        <li class="d-flex align-items-center" :class="item === 1 ? 'bg-gradient-primary' :'' " >
                                        <span class="avatar me-1">
                                            <img src="../../../app-assets/images/portrait/small/avatar-s-3.jpg" height="42" width="42" alt="Generic placeholder image">
                                            <span class="avatar-status-offline"></span>
                                        </span>
                                            <div class="chat-info flex-grow-1">
                                                <h5 class="mb-0">Elizabeth Elliott</h5>
                                                <p class="card-text text-truncate">
                                                    Cake pie jelly jelly beans...
                                                </p>
                                            </div>
                    ...
                    <div class="col-md-8 ms-0 ps-0">
                        <div class="card h-100 shadow-none mb-0 pb-0 rounded-0">
                                ...
                                <ul id="chat">
                                    <li class="you">
                                        ...
                                        <div class="message bg-gradient bg-white">
                                            ...
                                            <div class="info">
                                                <p class="name">~Jugol Kumar</p>
                                                <p class="time">Today, 12:55 pm</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="me">
                                        <div class="message bg-gradient-primary text-white">
                                            ...
                                            <div class="info">
                                                <p class="name text-white">~Jugol Kumar</p>
                                                <p class="time text-white">Today, 12:55 pm</p>
                                            </div>
                                        </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button class="btn-icon btn btn-light-success send-button">
                                    <vue-feather type="send" />
                                </button>
                            </div>
                        </div>
                    </div>
