...
&lt;!&ndash;                            <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <EditInvoice  :subtotal="totalPrice" :clients="props.clients" :errors="props.errors" :invoice="props.invoice" @storeEvent="saveInvoice">
...
const saveInvoice = (events) =>{
    Inertia.patch(props.update_url, {...formData, ...events}, {
        ...
        onSuccess: ()=> {$toast.success('Invoice Updated Successfully Done...') },
...
onMounted(() =>{
    const allItems = JSON.parse(props.invoice.items);
