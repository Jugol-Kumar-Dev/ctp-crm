<template>
    <Head title="Project For Employees"/>
...
<!--                                            <td>
                                            ...
                                            <td>
                                                ...
                                                $page.props.auth.user.can.includes('project.delete')||
    ...
    <Modal id="addItemModal" title="Add New Project" v-vb-is:modal size="lg" v-if="$page.props.auth.user.can.includes('project.create') || $page.props.auth.user.role.includes('Administrator')">
...
<script setup>
    ...
    watch([search, perPage], debounce(function ([val, val2]) {
        router.get(props.emp_url, {search: val, perPage: val2}, {preserveState: true, replace: true});
    }, 300));
