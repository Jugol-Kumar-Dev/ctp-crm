...
<!--                                            <td>{{ user.created_at }}</td>-->
                                            ...
                                            <td>
                                                ...
                                                $page.props.auth.user.role.includes('Administrator')">
                                                    ...
                                                    <CDropdownMenu>
                                                        <CDropdownItem  @click="editClient(user.show_url, 'onlyStatus')"   v-if="$page.props.auth.user.can.includes('client.edit') || $page.props.auth.user.role.includes('Administrator')">
                                                        ...
                                                        <CDropdownItem  @click="editClient(user.show_url)"   v-if="$page.props.auth.user.can.includes('client.edit') || $page.props.auth.user.role.includes('Administrator')">
                                                            <Icon title="pencil" />
                                                            <span class="ms-1">Edit</span>
                                                        </CDropdownItem>
                                                        <CDropdownItem :href="user.show_url" v-if="$page.props.auth.user.can.includes('client.show') || $page.props.auth.user.role.includes('Administrator')">
                                                            <Icon title="eye" />
